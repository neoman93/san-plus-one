(() => {
    ...
    function initSliders() {
        if (document.querySelector(".new-goods__slider")) new core(".new-goods__slider", {
            ...
            pagination: {
                el: ".new-goods__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".new-goods__button-prev",
                nextEl: ".new-goods__button-next"
            },
            on: {}
        });
        if (document.querySelector(".most-viewed__slider")) new core(".most-viewed__slider", {
            ...
            loop: true,
            pagination: {
                el: ".most-viewed__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".most-viewed__button-prev",
                nextEl: ".most-viewed__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".most-sold__slider")) new core(".most-sold__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            pagination: {
                el: ".most-sold__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".most-sold__button-prev",
                nextEl: ".most-sold__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".product-type__slider")) new core(".product-type__slider", {
            ...
            navigation: {
                prevEl: ".product-type__button-prev",
                nextEl: ".product-type__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
